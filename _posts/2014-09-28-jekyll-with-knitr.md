...
{% highlight text %}
##  [1]  9.44  9.77 11.56 10.07 10.13 11.72 10.46  8.73  9.31  9.55 11.22 10.36 10.40 10.11  9.44 11.79
## [17] 10.50  8.03 10.70  9.53  8.93  9.78  8.97  9.27  9.37  8.31 10.84 10.15  8.86 11.25 10.43  9.70
## [33] 10.90 10.88 10.82 10.69 10.55  9.94  9.69  9.62
{% endhighlight %}
...
![A scatterplot of the cars data](/figure/source/jekyll-with-knitr/2014-09-28-jekyll-with-knitr/cars-1.png)
...
{% highlight r %}
jekyll(dir = ".", input = c(".", "_source", "_posts"), output = c(".", "_posts", "_posts"),
